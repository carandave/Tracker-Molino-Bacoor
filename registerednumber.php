...
$sql = "SELECT * FROM resident ORDER BY id ASC";
$result = $db->query($sql);
if (!$result) {
            ...
            <div class="card-header">
				<div class="d-flex align-items-center justify-content-between">
					...
					<form action="search.php" method="GET" class="d-flex align-items-center justify-content-between">
							<input type="text" name="search" class="form-control mr-2" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Search Last Name">
                            ...
                            ?>
                                    <tr>
										...
										<td class="text-center d-flex">
                                            <a class="btn btn-info p-1 px-3" href="update2.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;
                                            <a class="btn btn-danger p-1 px-3" href="delete.php?id=<?php echo $row['id']; ?>">Delete</a>
                                        </td>
                                    </tr>                       
                            <?php       }
                                }
