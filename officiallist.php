				...
				<div class="d-flex align-items-center justify-content-between">
					...
					<div>
                      ...
                      <?php } ?>
						...
						<!-- <?php if($row2['position'] == "Executive Officer"){ ?>
                            <a class="btn btn-info" href="deleteofficial.php">Delete</a>
                      <?php } ?> -->
                        ...
                        <tbody> 
                            ...
                            ?>
                                    <tr>
										...
										<?php if($row2['position'] == "Executive Officer" ){ ?>
									 <td class="d-flex text-center"> <a class="btn btn-danger" href="deleteofficial.php?id=<?php echo $row['id']; ?>">Delete</a></td>
										<?php }?>
